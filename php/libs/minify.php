...
abstract class ZFreeMinify
{
    ...
    /**
     * @param ZFreeTemplate $tpl
     */
    public function __construct(ZFreeTemplate $tpl)
    {
        $this->_tpl  = $tpl;
     ...
     * @return JBlankMinify
     */
    public static function getProcessor($type = 'css', ZFreeTemplate $tpl)
    {
